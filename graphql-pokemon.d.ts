...
declare type Abilities = {
  ...
  readonly hidden?: Maybe<Ability>;
  /** The second ability of a Pokémon */
  readonly second?: Maybe<Ability>;
  /** The special ability of a Pokémon */
  readonly special?: Maybe<Ability>;
};
/** The supported abilities */
declare const enum AbilitiesEnum {
...
declare type Ability = {
   ...
   */
  readonly pokemonThatHaveThisAbility: ReadonlyArray<Maybe<Pokemon>>;
...
declare type LearnsetLevelUpMove = {
  /** The generation in which this pokémon learned the move this way */
  readonly generation: Scalars["Int"];
...
declare type Pokemon = {
  ...
  /** The key of the Pokémon as stored in the API */
  readonly key: PokemonEnum;
  /** The learnset for this pokemon */
  readonly learnsets?: Maybe<GenerationalPokemonLearnset>;
...
declare type Query = {
   ...
   */
  readonly getAllPokemon: ReadonlyArray<Pokemon>;
  /**
...
declare type QueryGetAbilityArgs = {
  ability: AbilitiesEnum;
};
declare type QueryGetAllPokemonArgs = {
...
declare type QueryGetFuzzyAbilityArgs = {
  ability: Scalars["String"];
  offset?: InputMaybe<Scalars["Int"]>;
  reverse?: InputMaybe<Scalars["Boolean"]>;
  take?: InputMaybe<Scalars["Int"]>;
};
declare type QueryGetFuzzyItemArgs = {
  item: Scalars["String"];
  offset?: InputMaybe<Scalars["Int"]>;
  reverse?: InputMaybe<Scalars["Boolean"]>;
  take?: InputMaybe<Scalars["Int"]>;
};
declare type QueryGetFuzzyLearnsetArgs = {
  generation?: InputMaybe<Scalars["Int"]>;
  moves: ReadonlyArray<Scalars["String"]>;
  pokemon: Scalars["String"];
};
declare type QueryGetFuzzyMoveArgs = {
  move: Scalars["String"];
  offset?: InputMaybe<Scalars["Int"]>;
  reverse?: InputMaybe<Scalars["Boolean"]>;
  take?: InputMaybe<Scalars["Int"]>;
};
declare type QueryGetFuzzyPokemonArgs = {
  offset?: InputMaybe<Scalars["Int"]>;
  offsetFlavorTexts?: InputMaybe<Scalars["Int"]>;
  pokemon: Scalars["String"];
  reverse?: InputMaybe<Scalars["Boolean"]>;
...
declare type QueryGetItemArgs = {
  item: ItemsEnum;
};
declare type QueryGetLearnsetArgs = {
  generation?: InputMaybe<Scalars["Int"]>;
  moves: ReadonlyArray<MovesEnum>;
  pokemon: PokemonEnum;
};
declare type QueryGetMoveArgs = {
  move: MovesEnum;
};
declare type QueryGetPokemonArgs = {
  offsetFlavorTexts?: InputMaybe<Scalars["Int"]>;
  pokemon: PokemonEnum;
  reverseFlavorTexts?: InputMaybe<Scalars["Boolean"]>;
  takeFlavorTexts?: InputMaybe<Scalars["Int"]>;
};
declare type QueryGetPokemonByDexNumberArgs = {
  number: Scalars["Int"];
  offsetFlavorTexts?: InputMaybe<Scalars["Int"]>;
  reverseFlavorTexts?: InputMaybe<Scalars["Boolean"]>;
  takeFlavorTexts?: InputMaybe<Scalars["Int"]>;
};
declare type QueryGetTypeMatchupArgs = {
...
declare type TypeEffectiveness = {
...
declare type TypeMatchup = {
  /** The type matchups when attacking */
  readonly attacking: TypeEffectiveness;
  /** The type matchups when defending */
  readonly defending: TypeEffectiveness;
};
/** The types in Pokémon */
declare const enum TypesEnum {
  Bug = "bug",
  Dark = "dark",
  Dragon = "dragon",
  Electric = "electric",
...
declare type Resolver<TResult, TParent = {}, TContext = {}, TArgs = {}> =
  | ResolverFn<TResult, TParent, TContext, TArgs>
  | ResolverWithResolve<TResult, TParent, TContext, TArgs>;
declare type ResolverFn<TResult, TParent, TContext, TArgs> = (
  parent: TParent,
  args: TArgs,
  context: TContext,
  info: GraphQLResolveInfo
) => Promise<TResult> | TResult;
declare type SubscriptionSubscribeFn<TResult, TParent, TContext, TArgs> = (
  parent: TParent,
  args: TArgs,
  context: TContext,
  info: GraphQLResolveInfo
) => AsyncIterable<TResult> | Promise<AsyncIterable<TResult>>;
declare type SubscriptionResolveFn<TResult, TParent, TContext, TArgs> = (
  parent: TParent,
  args: TArgs,
  context: TContext,
  info: GraphQLResolveInfo
...
declare type SubscriptionResolver<
  TResult,
  TKey extends string,
  TParent = {},
  TContext = {},
...
> =
  ...
  | SubscriptionObject<TResult, TKey, TParent, TContext, TArgs>;
declare type TypeResolveFn<TTypes, TParent = {}, TContext = {}> = (
  parent: TParent,
  context: TContext,
  info: GraphQLResolveInfo
) => Maybe<TTypes> | Promise<Maybe<TTypes>>;
declare type IsTypeOfResolverFn<T = {}, TContext = {}> = (
  obj: T,
  context: TContext,
  info: GraphQLResolveInfo
) => boolean | Promise<boolean>;
declare type NextResolverFn<T> = () => Promise<T>;
declare type DirectiveResolverFn<
  TResult = {},
  TParent = {},
  TContext = {},
  TArgs = {}
...
declare type ResolversTypes = {
  ...
  GenerationalPokemonLearnset: ResolverTypeWrapper<GenerationalPokemonLearnset>;
  ...
  PokemonLearnset: ResolverTypeWrapper<PokemonLearnset>;
...
declare type ResolversParentTypes = {
  ...
  Float: Scalars["Float"];
  Gender: Gender;
  GenerationalPokemonLearnset: GenerationalPokemonLearnset;
  Int: Scalars["Int"];
  Item: Item;
  Learnset: Learnset;
...
declare type AbilitiesResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes["Abilities"] = ResolversParentTypes["Abilities"]
> = {
  first?: Resolver<ResolversTypes["Ability"], ParentType, ContextType>;
  hidden?: Resolver<Maybe<ResolversTypes["Ability"]>, ParentType, ContextType>;
  second?: Resolver<Maybe<ResolversTypes["Ability"]>, ParentType, ContextType>;
  special?: Resolver<Maybe<ResolversTypes["Ability"]>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
declare type AbilityResolvers<
  ContextType = any,
...
> = {
  ...
  isFieldAbility?: Resolver<
    Maybe<ResolversTypes["String"]>,
    ParentType,
    ContextType
  >;
  key?: Resolver<ResolversTypes["AbilitiesEnum"], ParentType, ContextType>;
  name?: Resolver<ResolversTypes["String"], ParentType, ContextType>;
  pokemonThatHaveThisAbility?: Resolver<
    ReadonlyArray<Maybe<ResolversTypes["Pokemon"]>>,
    ParentType,
    ContextType
  >;
...
declare type CatchRateResolvers<
  ContextType = any,
...
> = {
  ...
  percentageWithOrdinaryPokeballAtFullHealth?: Resolver<
...
declare type EvYieldsResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes["EvYields"] = ResolversParentTypes["EvYields"]
> = {
...
declare type GenerationalPokemonLearnsetResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes["GenerationalPokemonLearnset"] = ResolversParentTypes["GenerationalPokemonLearnset"]
> = {
  generation3?: Resolver<
    ResolversTypes["PokemonLearnset"],
    ParentType,
    ContextType
  >;
  generation4?: Resolver<
    ResolversTypes["PokemonLearnset"],
    ParentType,
    ContextType
  >;
  generation5?: Resolver<
    ResolversTypes["PokemonLearnset"],
    ParentType,
    ContextType
  >;
  generation6?: Resolver<
    ResolversTypes["PokemonLearnset"],
    ParentType,
    ContextType
  >;
  generation7?: Resolver<
    ResolversTypes["PokemonLearnset"],
    ParentType,
    ContextType
  >;
  generation8?: Resolver<
    ResolversTypes["PokemonLearnset"],
    ParentType,
    ContextType
  >;
...
> = {
  ...
  generationIntroduced?: Resolver<
    ResolversTypes["Int"],
    ParentType,
    ContextType
  >;
  isNonstandard?: Resolver<
    Maybe<ResolversTypes["String"]>,
    ParentType,
    ContextType
  >;
  key?: Resolver<ResolversTypes["ItemsEnum"], ParentType, ContextType>;
  name?: Resolver<ResolversTypes["String"], ParentType, ContextType>;
  serebiiPage?: Resolver<ResolversTypes["String"], ParentType, ContextType>;
  shortDesc?: Resolver<
    Maybe<ResolversTypes["String"]>,
...
declare type LearnsetResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes["Learnset"] = ResolversParentTypes["Learnset"]
> = {
  backSprite?: Resolver<ResolversTypes["String"], ParentType, ContextType>;
  color?: Resolver<ResolversTypes["String"], ParentType, ContextType>;
  dreamworldMoves?: Resolver<
    Maybe<ReadonlyArray<ResolversTypes["LearnsetMove"]>>,
    ParentType,
    ContextType
  >;
  eggMoves?: Resolver<
  ...
  eventMoves?: Resolver<
    ...
    ContextType
  >;
  levelUpMoves?: Resolver<
    Maybe<ReadonlyArray<ResolversTypes["LearnsetLevelUpMove"]>>,
    ParentType,
    ContextType
  >;
  num?: Resolver<ResolversTypes["Int"], ParentType, ContextType>;
  pokemonKey?: Resolver<ResolversTypes["PokemonEnum"], ParentType, ContextType>;
...
declare type LearnsetLevelUpMoveResolvers<
  ContextType = any,
...
declare type LearnsetMoveResolvers<
  ContextType = any,
...
> = {
  ...
  contestType?: Resolver<
    Maybe<ResolversTypes["String"]>,
    ParentType,
    ContextType
  >;
  desc?: Resolver<Maybe<ResolversTypes["String"]>, ParentType, ContextType>;
  isFieldMove?: Resolver<
    Maybe<ResolversTypes["String"]>,
    ParentType,
    ContextType
  >;
  ...
  key?: Resolver<ResolversTypes["MovesEnum"], ParentType, ContextType>;
  maxMovePower?: Resolver<
...
> = {
  ...
  bulbapediaPage?: Resolver<ResolversTypes["String"], ParentType, ContextType>;
  catchRate?: Resolver<
    Maybe<ResolversTypes["CatchRate"]>,
    ParentType,
    ContextType
  >;
  color?: Resolver<ResolversTypes["String"], ParentType, ContextType>;
  cosmeticFormes?: Resolver<
  ...
  evolutionLevel?: Resolver<
    Maybe<ResolversTypes["String"]>,
    ParentType,
    ContextType
  >;
  evolutions?: Resolver<
    Maybe<ReadonlyArray<ResolversTypes["Pokemon"]>>,
    ParentType,
    ContextType
  >;
  flavorTexts?: Resolver<
    ReadonlyArray<ResolversTypes["Flavor"]>,
    ParentType,
    ContextType
  >;
  forme?: Resolver<Maybe<ResolversTypes["String"]>, ParentType, ContextType>;
  formeLetter?: Resolver<
    Maybe<ResolversTypes["String"]>,
    ParentType,
    ContextType
  >;
  ...
  isEggObtainable?: Resolver<
    ResolversTypes["Boolean"],
    ParentType,
    ContextType
  >;
  key?: Resolver<ResolversTypes["PokemonEnum"], ParentType, ContextType>;
  learnsets?: Resolver<
    Maybe<ResolversTypes["GenerationalPokemonLearnset"]>,
    ParentType,
    ContextType
  >;
  levellingRate?: Resolver<
    Maybe<ResolversTypes["String"]>,
    ParentType,
    ContextType
  >;
  maximumHatchTime?: Resolver<
    Maybe<ResolversTypes["Int"]>,
    ParentType,
    ContextType
  >;
  minimumHatchTime?: Resolver<
    Maybe<ResolversTypes["Int"]>,
    ParentType,
    ContextType
  >;
  num?: Resolver<ResolversTypes["Int"], ParentType, ContextType>;
  otherFormes?: Resolver<
    Maybe<ReadonlyArray<ResolversTypes["String"]>>,
    ParentType,
    ContextType
  >;
  preevolutions?: Resolver<
    Maybe<ReadonlyArray<ResolversTypes["Pokemon"]>>,
    ParentType,
    ContextType
  >;
  ...
  sprite?: Resolver<ResolversTypes["String"], ParentType, ContextType>;
  types?: Resolver<
    ReadonlyArray<ResolversTypes["PokemonType"]>,
    ParentType,
    ContextType
  >;
...
declare type PokemonLearnsetResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes["PokemonLearnset"] = ResolversParentTypes["PokemonLearnset"]
> = {
  dreamworldMoves?: Resolver<
    Maybe<ReadonlyArray<ResolversTypes["LearnsetMove"]>>,
    ParentType,
...
declare type PokemonTypeResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes["PokemonType"] = ResolversParentTypes["PokemonType"]
> = {
  matchup?: Resolver<ResolversTypes["TypeMatchup"], ParentType, ContextType>;
  name?: Resolver<ResolversTypes["String"], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
declare type QueryResolvers<
  ContextType = any,
...
> = {
  getAbility?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<QueryGetAbilityArgs, "ability">
  >;
  getAllPokemon?: Resolver<
  ...
  >;
  getFuzzyLearnset?: Resolver<
    ResolversTypes["Learnset"],
    ParentType,
    ContextType,
    RequireFields<QueryGetFuzzyLearnsetArgs, "moves" | "pokemon">
  >;
  ...
  getItem?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<QueryGetItemArgs, "item">
  >;
  getLearnset?: Resolver<
    ResolversTypes["Learnset"],
    ParentType,
    ContextType,
    RequireFields<QueryGetLearnsetArgs, "moves" | "pokemon">
  >;
  getMove?: Resolver<
    ResolversTypes["Move"],
    ParentType,
    ContextType,
    RequireFields<QueryGetMoveArgs, "move">
  >;
  getPokemon?: Resolver<
    ...
    RequireFields<
      QueryGetPokemonArgs,
      "offsetFlavorTexts" | "pokemon" | "reverseFlavorTexts" | "takeFlavorTexts"
    >
  >;
  getPokemonByDexNumber?: Resolver<
    ...
    ContextType,
    RequireFields<
      QueryGetPokemonByDexNumberArgs,
      "number" | "offsetFlavorTexts" | "reverseFlavorTexts" | "takeFlavorTexts"
    >
  >;
  getTypeMatchup?: Resolver<
    ResolversTypes["TypeMatchup"],
    ParentType,
    ContextType,
    RequireFields<QueryGetTypeMatchupArgs, "primaryType">
  >;
};
declare type StatsResolvers<
  ContextType = any,
...
declare type TypeEffectivenessResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes["TypeEffectiveness"] = ResolversParentTypes["TypeEffectiveness"]
> = {
  doubleEffectiveTypes?: Resolver<
    ReadonlyArray<ResolversTypes["String"]>,
    ParentType,
    ContextType
  >;
  doubleResistedTypes?: Resolver<
    ReadonlyArray<ResolversTypes["String"]>,
    ParentType,
    ContextType
  >;
  effectiveTypes?: Resolver<
    ReadonlyArray<ResolversTypes["String"]>,
    ParentType,
    ContextType
  >;
  effectlessTypes?: Resolver<
    ReadonlyArray<ResolversTypes["String"]>,
    ParentType,
    ContextType
  >;
  normalTypes?: Resolver<
    ReadonlyArray<ResolversTypes["String"]>,
    ParentType,
    ContextType
  >;
  resistedTypes?: Resolver<
    ReadonlyArray<ResolversTypes["String"]>,
    ParentType,
    ContextType
  >;
...
declare type Resolvers<ContextType = any> = {
  ...
  GenerationalPokemonLearnset?: GenerationalPokemonLearnsetResolvers<ContextType>;
  ...
  PokemonLearnset?: PokemonLearnsetResolvers<ContextType>;
...
export {
  ...
  GenerationalPokemonLearnsetResolvers,
  InputMaybe,
  IsTypeOfResolverFn,
  Item,
  ItemResolvers,
  ...
  Learnset,
  LearnsetLevelUpMove,
  LearnsetLevelUpMoveResolvers,
  LearnsetMove,
  LearnsetMoveResolvers,
  LearnsetResolvers,
  MakeMaybe,
  MakeOptional,
  Maybe,
  ...
  TypeEffectiveness,
  TypeEffectivenessResolvers,
  TypeMatchup,
  TypeMatchupResolvers,
  TypeResolveFn,
  TypesEnum,
};
